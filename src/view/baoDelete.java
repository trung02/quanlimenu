 ...
 * @author trunghuynh
 */
public class baoDelete extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(baoDelete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
