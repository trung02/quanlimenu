 ...
 * @author trunghuynh
 */
public class baoUpdate extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(baoUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
